 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.resume.resume.impl.StringListImpl#getValues <em>Values</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StringListImpl extends MinimalEObjectImpl.Container implements StringList
{
  ...
  {
    return ResumePackage.Literals.STRING_LIST;
  }
  ...
  public EList<String> getValues()
  {
    if (values == null)
    {
      values = new EDataTypeEList<String>(String.class, this, ResumePackage.STRING_LIST__VALUES);
    }
    return values;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ResumePackage.STRING_LIST__VALUES:
        return getValues();
    }
