...
public class ResumeGenerator extends AbstractGenerator {
  ...
  public void doGenerate(final Resource resource, final IFileSystemAccess2 fsa, final IGeneratorContext context) {
    ...
    final int matchPercentage = this.calculateMatchPercentage(profile, requiredTags);
    fsa.generateFile("Dashboard_CV.html", this.generateHTML(profile, requiredTags, matchPercentage, matchedJobs, omittedJobs, matchedProjects, omittedProjects, matchedEducation));
  }

  public int calculateMatchPercentage(final Profile profile, final List<String> requiredTags) {
  ...
  public CharSequence generateHTML(final Profile profile, final List<String> requiredTags, final int matchPercentage, final List<Job> mJobs, final List<Job> oJobs, final List<Project> mProj, final List<Project> oProj, final List<Degree> mEdu) {
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("/* Estilos para la barra de progreso */");
    _builder.newLine();
    _builder.append("\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("<h2>\ud83d\udcca Análisis de Compatibilidad</h2>");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("<p><b>Tags Requeridos:</b> ");
    ...
    _builder.newLine();
    {
      if ((oJobs.isEmpty() && oProj.isEmpty())) {
        _builder.append("\t\t\t");
        _builder.append("<li style=\"color: green;\">¡Excelente! Todo tu historial hace match con esta oferta.</li>");
        _builder.newLine();
      } else {
        _builder.append("\t\t\t");
        {
    ...
    _builder.newLine();
    {
      boolean _isEmpty = mProj.isEmpty();
    ...
    _builder.newLine();
    {
      boolean _isEmpty_1 = mJobs.isEmpty();
    ...
    _builder.newLine();
    {
      boolean _isEmpty_2 = mEdu.isEmpty();
